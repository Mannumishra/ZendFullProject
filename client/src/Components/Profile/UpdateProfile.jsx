...
const UpdateProfile = () => {
    ...
    const postData = async (e) => {
        ...
        try {
            ...
            let res = await axios.put(`https://api.zenshealthcare.co.in/api/user/${sessionStorage.getItem("userid")}`, formData);
    ...
    const getAPIData = async () => {
        try {
            let res = await axios.get(`https://api.zenshealthcare.co.in/api/user/${sessionStorage.getItem("userid")}`);
