...
const Profile = () => {
    ...
    useEffect(() => {
        const getApiData = async () => {
            try {
                let res = await axios.get("http://localhost:8001/api/user/" + sessionStorage.getItem("userid"));
        ...
        const getOrderData = async () => {
            try {
                let res = await axios.get("http://localhost:8001/api/checkout/user/" + sessionStorage.getItem("userid"));
