...
const EditBanner = () => {
    ...
    useEffect(() => {
        const fetchBanner = async () => {
            try {
                const res = await axios.get(`https://api.zenshealthcare.co.in/api/banner/${id}`);
                console.log(res)
                if (res.status === 200) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.patch(`https://api.zenshealthcare.co.in/api/banner/${id}`, formData, {
                headers: {
