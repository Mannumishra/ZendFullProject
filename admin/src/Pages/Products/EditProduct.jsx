...
const EditProduct = () => {
    ...
    const getProductData = async () => {
        try {
            const res = await axios.get(`https://api.zenshealthcare.co.in/api/products/${id}`);
            console.log(res)
            if (res.status === 200) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://api.zenshealthcare.co.in/api/products/${id}`, form, {
                headers: {
